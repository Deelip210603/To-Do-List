# To-Do-List
TO DO LIST python progarm output

Sample output for the above code : To-Do-List Application menu 1.Display To-Do List
...
To-Do-List Application menu 1.Display To-Do List
